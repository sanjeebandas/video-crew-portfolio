  ...
  return (
    <div className="w-full">
      ...
      >
        {/* Step Number */}
        <div
          className={`absolute text-[120px] md:text-[135px] lg:text-[150px] font-extrabold text-white opacity-10 pointer-events-none
             ${
               reverse
                 ? "left-0 -translate-x-[6px] -top-16 md:right-0 md:left-auto md:translate-x-[6px] md:-top-18 lg:-top-20"
                 : "left-0 -translate-x-[6px] -top-16 md:-top-18 lg:-top-20"
             }`}
        >
          {id}
        </div>
        ...
        <div
          className={`relative z-20 w-full md:w-[500px] lg:w-[585px] mt-20 md:mt-22 lg:mt-24 ${
            reverse
