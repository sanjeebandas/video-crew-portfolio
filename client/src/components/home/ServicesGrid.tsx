...
const ServicesGrid = () => {
  ...
  return (
    <section className="w-full bg-black text-white px-4 xs:px-6 md:px-8 lg:px-6 py-12 xs:py-14 md:py-8">
      ...
      */}
      <div className="services-grid-container max-w-[1248px] mx-auto grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 gap-4 xs:gap-6 place-items-center">
        {services.map((service, idx) => (
          ...
          >
            ...
            {/* Very subtle overlay for text readability - scaled on ultra-wide */}
            <div className="card-overlay absolute bottom-0 left-0 w-full p-4 xs:p-5 sm:p-5 md:p-6 lg:p-7 bg-gradient-to-t from-black/80 via-black/30 to-transparent">
